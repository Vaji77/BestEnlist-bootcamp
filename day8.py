...
# 5.program to take string as input and change all the occurence  of the first character with the user input

inp3 = input("enter string :\n")
inp4 = input("enter the character that has to be replaced with first character:\n")
replacedword = inp3.replace(inp3[0], inp4 )

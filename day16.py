# 1.Create a lambda function that multiplies argument x and argument y
r = lambda x, y : x * y
print(r(10, 4))

# 2. python program to create fibonacci series to n using lambda
from functools import reduce

fib = lambda n: reduce(lambda x, _: x + [x[-1] + x[-2]],
                       range(n - 2), [0, 1])

print("fibonacci series=",fib(11))

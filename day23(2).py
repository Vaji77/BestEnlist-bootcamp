# Create another button as ‘fetch button’
# Have a functionality of fetching the weather on a given location in text box
...
frame = tk.Frame(root, bg='Yellow', bd=25)
...
lower_frame = tk.Frame(root, bg='Green Yellow', bd=10)

...
# Create two browse button
# Place the .pdf file for the buttons
# Create a merge pdf option
...
lbl_open = tk.Label(fr_bg1, text="Select 2 pdf or more to merge ")
lbl_open.grid(row=0, column=0, sticky="ew", padx=5, pady=5)

btn_open = tk.Button(fr_bg1, text="Open file", bg='Red2', fg='white', font=('helvetica', 12, 'bold'),
...
btn_merge = tk.Button(fr_bg2, text="Merge PDF", bg='Navy', fg='white', font=('helvetica', 12, 'bold'),
                      state="disabled",
                      command=lambda: merge_pdfs(filelist))
btn_merge.grid(row=2, column=0, sticky="ew", padx=5, pady=5)
fr_bg2.pack()

btn_exit = tk.Button(window, text="Exit", command=window.destroy, bd=2, bg='Green2', fg='black',
